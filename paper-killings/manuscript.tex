...
As a last robustness test for the EBA, I ran the main model with peace years only; that is, only country-years in which the UCDP, COW and Cederman et al's measures of civil conflicts had a value of zero. The results are very similar to the original model, what indicates that the difference in the results is conditional on civil war years.
